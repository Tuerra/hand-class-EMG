 ...
 Ts=0.05;
 num_act=30;
 %run('Z:\Users\umbertoscarcia\Dropbox\lar\Dynamixel\Object_info.m')
THUMB   =      1
INDEX   =      2
MIDDLE  =      3
RING    =      4
...
q3 = 0:0.01:110/180*pi;
l2=zeros(5,size(q3,2));
for(i=2:5)
l2(i,:) =  sqrt(a_f(i,2)^2 + a_f(i,3)^2 + a_f(i,4)^2 + 2*a_f(i,3)*a_f(i,4)*cos(k*q3) +2*a_f(i,2)*a_f(i,3)*cos(q3) + 2*a_f(i,2)*a_f(i,4)*cos(q3*(1+k)));
% l2_data(i,:) = min(l2(i,:)):0.01:max(l2(i,:));
l2_4_coeff(i,:) = polyfit(q3,l2(i,:),4)
% l2_4(i,:) = polyval(l2_4_coeff(i,:),q3);
end
% subplot(2,1,1)
% plot(q3,l2,q3,l2_2,q3,l2_3,q3,l2_4)
% 
% subplot(2,1,2)
% plot(q3,l2-l2_2,q3,l2-l2_3,q3,l2-l2_4)
% 
% 
% roots(l2_4_coeff-[0 0 0 0 af2+af3+af4-30])
% 
